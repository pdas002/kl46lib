...
#define UART0_NVIC_IRQ		(12)
#define NVIC_ICPR_UART0_MASK 	(1 << UART0_NVIC_IRQ)

#define NVIC_ISER_UART0_MASK 	(1 << UART0_NVIC_IRQ)

#define UART0_IPR_REGISTER 	(UART0_NVIC_IRQ >> 2)

#define NVIC_IPR_UART0_MASK \
                      (3 << (((UART0_NVIC_IRQ & 3) << 3) + 6))
